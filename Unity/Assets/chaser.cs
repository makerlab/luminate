...
public class chaser : MonoBehaviour {
	...
	void OnGUI() {
		...
		if (GUI.Button(new Rect(220,Screen.height-60, 80, 40), "calligraphy")) {
			style = MyLine.STYLE.CURSIVE;
		}
		
		if (GUI.Button(new Rect(320,Screen.height-60, 80, 40), "prism")) {
			style = MyLine.STYLE.PRISM;
		}
		
		if (GUI.Button(new Rect(420,Screen.height-60, 80, 40), "glow")) {
			style = MyLine.STYLE.GLOW;
		}
		
		if (GUI.Button(new Rect(520,Screen.height-60, 80, 40), "sparkle")) {
			style = MyLine.STYLE.SPARKLE;
		}
		
		if (GUI.Button(new Rect(620,Screen.height-60, 80, 40), "blocks")) {
			style = MyLine.STYLE.BLOCK;
		}
		
		if (GUI.Button(new Rect(720,Screen.height-60, 80, 40), "magnetic")) {
			style = MyLine.STYLE.PUTTY;
		}
	}	
}
