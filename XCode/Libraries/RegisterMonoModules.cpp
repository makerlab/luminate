...
extern "C"
{
	...
	void	setFreezeTrackingInternal();
	void	pauseTracking();
	void	resumeTracking();
	void	registerCallback();
	void	getUnityCallbackEventID();
	void	getUnityCallbackEventValue();
	void	removeUnityCallbackEvent();
	void	setScreenRotation();
	void	getScreenRotation();
	void	resizeRenderer();
	void	UnityRenderEvent();
	void	setTrackingConfiguration();
	void	setCameraParametersFromFileNative();
	void	getCameraParametersNative();
	void	setHandEyeCalibrationNative();
	void	setRendererClippingPlaneLimitsNative();
	void	setLLAObjectRenderingLimits();
	void	getCameraImageCoordinatesFrom3DPositionNative();
	void	getRequiredTextureSize();
	void	getCameraPlaneScale();
	void	getSensorGravity();
	void	getLocation();
	void	getHandEyeCalibrationInternal();
	void	getProjectionMatrixInternal();
	void	getNumberOfValidCoordinateSystems();
	void	getNumberOfDefinedCoordinateSystems();
	void	getTrackingValues();
	void	setTrackingEventCallbackReceivesAllChanges();
	void	getRenderingDuration();
	void	getTrackingDuration();
	void	getRenderingFrameRate();
	void	getTrackingFrameRate();
	void	getCameraFrameRate();
	void	freeReturnedMemory();
	void	listCamerasInternal();
	void	startSensors();
	void	stopSensors();
	void	pauseSensors();
	void	resumeSensors();
	void	getRunningSensors();
	void	onPauseApplication();
	void	onResumeApplication();
	void	setImageInternal();
	void	setImageInternalFromImage();
	void	setManualLocation();
	void	resetManualLocation();
	void	setCosOffset();
	void	requestCameraImage();
	void	startInstantTrackingInternal();
	void	convertLLAToTranslation();
	void	createGeometryFromMovie();
	void	deleteMovieGeometry();
	void	getMovieTextureHeight();
	void	getMovieTextureWidth();
	void	getMovieTextureDisplayAspect();
	void	setMovieTextureTargetTextureID();
	void	startMovieTexture();
	void	pauseMovieTexture();
	void	stopMovieTexture();
	void	requestVisualSearch();
	void	sensorCommandNative();
	void	getCoordinateSystemNameNative();
	void	getCoordinateSystemID();
	void	get3DPointsFrom3DmapInternal();
...
void RegisterMonoModules()
{
	...
	mono_dl_register_symbol("getVersionNative", (void*)&getVersionNative);
	mono_dl_register_symbol("enableBackgroundProcessing", (void*)&enableBackgroundProcessing);
	mono_dl_register_symbol("disableBackgroundProcessing", (void*)&disableBackgroundProcessing);
	mono_dl_register_symbol("deleteMetaioSDKUnity", (void*)&deleteMetaioSDKUnity);
	mono_dl_register_symbol("setFreezeTrackingInternal", (void*)&setFreezeTrackingInternal);
	mono_dl_register_symbol("pauseTracking", (void*)&pauseTracking);
	mono_dl_register_symbol("resumeTracking", (void*)&resumeTracking);
	mono_dl_register_symbol("registerCallback", (void*)&registerCallback);
	mono_dl_register_symbol("getUnityCallbackEventID", (void*)&getUnityCallbackEventID);
	mono_dl_register_symbol("getUnityCallbackEventValue", (void*)&getUnityCallbackEventValue);
	mono_dl_register_symbol("removeUnityCallbackEvent", (void*)&removeUnityCallbackEvent);
	mono_dl_register_symbol("setScreenRotation", (void*)&setScreenRotation);
	mono_dl_register_symbol("getScreenRotation", (void*)&getScreenRotation);
	mono_dl_register_symbol("resizeRenderer", (void*)&resizeRenderer);
	mono_dl_register_symbol("UnityRenderEvent", (void*)&UnityRenderEvent);
	mono_dl_register_symbol("setTrackingConfiguration", (void*)&setTrackingConfiguration);
	mono_dl_register_symbol("setCameraParametersFromFileNative", (void*)&setCameraParametersFromFileNative);
	mono_dl_register_symbol("getCameraParametersNative", (void*)&getCameraParametersNative);
	mono_dl_register_symbol("setHandEyeCalibrationNative", (void*)&setHandEyeCalibrationNative);
	mono_dl_register_symbol("setRendererClippingPlaneLimitsNative", (void*)&setRendererClippingPlaneLimitsNative);
	mono_dl_register_symbol("setLLAObjectRenderingLimits", (void*)&setLLAObjectRenderingLimits);
	mono_dl_register_symbol("getCameraImageCoordinatesFrom3DPositionNative", (void*)&getCameraImageCoordinatesFrom3DPositionNative);
	mono_dl_register_symbol("getRequiredTextureSize", (void*)&getRequiredTextureSize);
	...
	mono_dl_register_symbol("getHandEyeCalibrationInternal", (void*)&getHandEyeCalibrationInternal);
	mono_dl_register_symbol("getProjectionMatrixInternal", (void*)&getProjectionMatrixInternal);
	mono_dl_register_symbol("getNumberOfValidCoordinateSystems", (void*)&getNumberOfValidCoordinateSystems);
	mono_dl_register_symbol("getNumberOfDefinedCoordinateSystems", (void*)&getNumberOfDefinedCoordinateSystems);
	mono_dl_register_symbol("getTrackingValues", (void*)&getTrackingValues);
	mono_dl_register_symbol("setTrackingEventCallbackReceivesAllChanges", (void*)&setTrackingEventCallbackReceivesAllChanges);
	mono_dl_register_symbol("getRenderingDuration", (void*)&getRenderingDuration);
	mono_dl_register_symbol("getTrackingDuration", (void*)&getTrackingDuration);
	mono_dl_register_symbol("getRenderingFrameRate", (void*)&getRenderingFrameRate);
	mono_dl_register_symbol("getTrackingFrameRate", (void*)&getTrackingFrameRate);
	mono_dl_register_symbol("getCameraFrameRate", (void*)&getCameraFrameRate);
	mono_dl_register_symbol("freeReturnedMemory", (void*)&freeReturnedMemory);
	mono_dl_register_symbol("listCamerasInternal", (void*)&listCamerasInternal);
	...
	mono_dl_register_symbol("getRunningSensors", (void*)&getRunningSensors);
	mono_dl_register_symbol("onPauseApplication", (void*)&onPauseApplication);
	mono_dl_register_symbol("onResumeApplication", (void*)&onResumeApplication);
	mono_dl_register_symbol("setImageInternal", (void*)&setImageInternal);
	mono_dl_register_symbol("setImageInternalFromImage", (void*)&setImageInternalFromImage);
	...
	mono_dl_register_symbol("startInstantTrackingInternal", (void*)&startInstantTrackingInternal);
	mono_dl_register_symbol("convertLLAToTranslation", (void*)&convertLLAToTranslation);
	mono_dl_register_symbol("createGeometryFromMovie", (void*)&createGeometryFromMovie);
	mono_dl_register_symbol("deleteMovieGeometry", (void*)&deleteMovieGeometry);
	mono_dl_register_symbol("getMovieTextureHeight", (void*)&getMovieTextureHeight);
	mono_dl_register_symbol("getMovieTextureWidth", (void*)&getMovieTextureWidth);
	mono_dl_register_symbol("getMovieTextureDisplayAspect", (void*)&getMovieTextureDisplayAspect);
	mono_dl_register_symbol("setMovieTextureTargetTextureID", (void*)&setMovieTextureTargetTextureID);
	mono_dl_register_symbol("startMovieTexture", (void*)&startMovieTexture);
	mono_dl_register_symbol("pauseMovieTexture", (void*)&pauseMovieTexture);
	mono_dl_register_symbol("stopMovieTexture", (void*)&stopMovieTexture);
	mono_dl_register_symbol("requestVisualSearch", (void*)&requestVisualSearch);
	mono_dl_register_symbol("sensorCommandNative", (void*)&sensorCommandNative);
	mono_dl_register_symbol("getCoordinateSystemNameNative", (void*)&getCoordinateSystemNameNative);
	mono_dl_register_symbol("getCoordinateSystemID", (void*)&getCoordinateSystemID);
	mono_dl_register_symbol("get3DPointsFrom3DmapInternal", (void*)&get3DPointsFrom3DmapInternal);
	mono_dl_register_symbol("startCameraInternal", (void*)&startCameraInternal);
	mono_dl_register_symbol("startCamera", (void*)&startCamera);
	mono_dl_register_symbol("stopCamera", (void*)&stopCamera);
	mono_dl_register_symbol("setSeeThrough", (void*)&setSeeThrough);
	mono_dl_register_symbol("setStereoRendering", (void*)&setStereoRendering);
